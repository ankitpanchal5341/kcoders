            ...
            <>
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                ...
                <a href="/" className="flex items-center space-x-2 text-2xl font-medium text-indigo-500 dark:text-gray-100">
                  ...
                  <div style={{ display: 'flex', flexDirection: 'column', fontSize: 35 }}>

                    <span style={{ lineHeight: 1, fontFamily: 'cursive' }}><span style={{ color: 'darkcyan' }}>K</span>wik Coders</span>
                    <span style={{ fontSize: 13, color: "black", lineHeight: 1 }}>Technologies Co. LLC</span>
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    {navigation.map((item, index) => (
                      // <Link >
                      <a key={index} href="#" className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 dark:focus:bg-gray-800 focus:outline-none dark:focus:bg-trueGray-700">
                        {item}
                      </a  >
                      // </Link>
                    ))}
